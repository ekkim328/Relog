...
export default function StatsPage({ relationshipId }) {
  const [data, setData] = useState(null)
  const [error, setError] = useState('')
  useEffect(() => {
    Promise.all([getRelationship(relationshipId), getRelationshipStats(relationshipId)])
      .then(([relationship, stats]) => setData({ relationship, stats }))
